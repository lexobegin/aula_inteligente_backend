"""
Django settings for aula_inteligente_backend project.
...
SECRET_KEY = 'django-insecure-^rf$xs&z*ujw(3a!es+p4+7n*7(!18+^bog64uwj_u_&6@-n)!'
...
ROOT_URLCONF = 'aula_inteligente_backend.urls'
...
WSGI_APPLICATION = 'aula_inteligente_backend.wsgi.application'
