# Generated by Django 5.2.1 on 2025-05-19 21:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(blank=True, choices=[('ADMINISTRADOR', 'Administrador'), ('PROFESOR', 'Profesor'), ('ALUMNO', 'Alumno'), ('APODERADO', 'Apoderado')], max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telefono_emergencia', models.CharField(blank=True, max_length=40, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Apoderado',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_fin', models.DateField()),
                ('tipo', models.CharField(max_length=50)),
                ('gestion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.gestionacademica')),
            ],
        ),
        migrations.CreateModel(
            name='Nota',
            fields=[
                ...
                ('inscripcion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.inscripcion')),
                ('periodo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.periodoacademico')),
            ],
        ),
        migrations.AddField(
            model_name='clase',
            name='periodo',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.periodoacademico'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            options={
                'constraints': [models.UniqueConstraint(fields=('alumno', 'apoderado'), name='unique_alumno_apoderado')],
            },
        ),
    ]
